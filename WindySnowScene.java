 ...
 * by simulating a snowstorm. With wind.
 * 
...
public class WindySnowScene extends MouseAdapter implements Runnable {
	...
	public void run() {
		...
		JFrame frame = new JFrame("WindySnowScene");
	...
	public static void main(String args[]) {
		...
		javax.swing.SwingUtilities.invokeLater(new WindySnowScene());
	}
}
